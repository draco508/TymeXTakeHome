...
//  123yo
//
//  Created by NguyenNV on 17/11/2023.
//
...
public class WaterfallLayout: UICollectionViewLayout {
    ...
    lazy var headersAttribute = [Int: UICollectionViewLayoutAttributes]()
    lazy var footersAttribute = [Int: UICollectionViewLayoutAttributes]()
    lazy var columnHeights = [[CGFloat]]()
    lazy var allItemAttributes = [UICollectionViewLayoutAttributes]()
    lazy var sectionItemAttributes = [[UICollectionViewLayoutAttributes]]()
    lazy var cachedItemSizes = [IndexPath: CGSize]()
